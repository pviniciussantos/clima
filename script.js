...
//vaiáveis de resultado das informações
...
const api_key = "d6ad3d1ddd1fd46b56327ae87144d9c4";
...
navigator.geolocation.getCurrentPosition(
    ...
    (err) => {
        if(err.code === 1){
            alert("Geolocalização negada pelo usuário, então busque manualmente pela cidade que deseja consultar na barra de pesquisa")
        } else {
         console.log(err)
        }
    }
